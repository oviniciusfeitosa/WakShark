...
namespace WakBoy
{
    class Testes
    {
        /*
          ...
          brightness2 = ServiceTela.mudarClaridadeCor(objColor2, 0.17f).GetBrightness();
          MessageBox.Show("brightness1:" + brightness.ToString() + "    \n brightness2:" + brightness2.ToString());
        ...
        objColor2.Hue = objColor.Hue;
        objColor2.Saturation = objColor.Saturation;
        objColor2.Luminosity = objColor.Luminosity;
