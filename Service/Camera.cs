...
namespace Service
{
    public class Camera
    {
        ...
        public void padronizarDistanciaCamera()
        {
            ...
            for (int zoomIn = 1; zoomIn < 15; zoomIn++) objInputSimulator.Keyboard.KeyPress(VirtualKeyCode.ADD);
            for (int zoomOut = 1; zoomOut < 12; zoomOut++) objInputSimulator.Keyboard.KeyPress(VirtualKeyCode.SUBTRACT);
        }
    }
}
